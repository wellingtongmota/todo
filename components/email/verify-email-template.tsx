...
export function VerifyEmailTemplate({ url }: VerifyEmailTemplateProps) {
  const previewText = `Verify your email address for todoNookdev`
        ...
        <Container style={containerStyle}>
          ...
          <Section style={mainSectionStyle}>
            ...
            <Text style={paragraphStyle}>
              Thanks for signing up for todoNookdev! To complete your
              registration and get started, please verify your email address.
            </Text>
